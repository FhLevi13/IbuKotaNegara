...
public class DataIbukota {
    public static String[][] data = new String[][] {
            ...
            {"Manila","Manila - Ibu Kota Filipina\n" +
                    ...
                    "\n","https://fhlevi13.github.io/img/ibu-kota-negara/Manila.jpeg"},
            {"Singapura","Singapura - Ibu Kota Singapura\n" +
                    "Luas Wilayah : 697 km2\n" +
                    "Singapura (nama resmi: Republik Singapura) adalah sebuah negara pulau di lepas ujung selatan Semenanjung Malaya, 137 kilometer (85 mi) di utara khatulistiwa di Asia Tenggara. Negara ini terpisah dari Malaysia oleh Selat Johor di utara, dan dari Kepulauan Riau, Indonesia oleh Selat Singapura di selatan. Singapura adalah pusat keuangan terdepan ketiga di dunia dan sebuah kota dunia kosmopolitan yang memainkan peran penting dalam perdagangan dan keuangan internasional. Pelabuhan Singapura adalah satu dari lima pelabuhan tersibuk di dunia.Singapura memiliki sejarah imigrasi yang panjang.Penduduknya yang beragam , terdiri dari Orang Tionghoa, Melayu, India, Arab, berbagai keturunan Asia, dan Kaukasoid.42% penduduk Singapura adalah orang asing yang bekerja dan menuntut ilmu di sana. Pekerja asing membentuk 50% dari sektor jasa. Negara ini adalah yang terpadat kedua di dunia setelah Monako.A.T. Kearney menyebut Singapura sebagai negara paling terglobalisasi di dunia dalam Indeks Globalisasi tahun 2006.","https://fhlevi13.github.io/img/ibu-kota-negara/Singapura.jpeg"},
            {"Bandar Seri Begawan","Bandar Seri Begawan - Ibu Kota Brunei Darussalam\n" +
                    "Luas Wilayah : 5.765 km2\n" +
                    "Bandar Seri Begawan (atau disingkat BSB), adalah ibu kota kesultanan Brunei Darussalam. Kota ini merupakan produsen mebel, tekstil, kerajinan tangan, dan kayu. Di sinilah tempat Balai Upacara Kerajaan, Bangunan Tanda Kebesaran Kerajaan dan Pusat Sejarah Brunei.\n" +
                    "Kota ini juga unik karena memiliki sebuah desa dekat air, Kampung Ayer yang memiliki rumah di atas jangkungan dan terbentang sampai ke laut sejauh 500 m. Bagian pertama namanya Bandar berasal dari Bahasa Persia بندر dan berarti 'pelabuhan' atau 'tempat tinggal'.\n","https://fhlevi13.github.io/img/ibu-kota-negara/Bandar-Seri-Begawan.jpeg"},
            {"Hanoi","Hanoi - Ibu Kota Vietnam\n" +
                    "Luas Wilayah : 331.210 km2\n" +
                    "Hanoi (Bahasa Vietnam: Hà Nội; Chữ Nôm: 河内), perkiraan populasi 3.500.800 jiwa (1997), adalah ibu kota Vietnam dan dahulunya ibu kota Vietnam Utara dari 1954 hingga 1976. Kota ini terletak di tepi kanan Delta Sungai Merah. Industri yang dihasilkan Vietnam ialah peralatan mesin, kayu lapis, tekstil, kimia, dan rajutan tangan.\n" +
                    ...
                    "Hanoi dijajah Jepang pada 1940, dan dibebaskan tahun 1945, ketika ia menjadi pusat pemerintahan Vietnam.\n","https://fhlevi13.github.io/img/ibu-kota-negara/Hanoi.jpeg"},
            {"Vientiane","Vientiane - Ibu Kota Laos\n" +
                    "Luas Wilayah : 236.800 km2\n" +
                    "Vientiane (bahasa Laos: ວຽງຈັນ, translit. IPA-lo, har. 'wíəŋ tɕàn' dibaca Wiang Chan) adalah ibu kota Laos yang terletak di Lembah Mekong. Vientiane merupakan bagian dari prefektur Vientiane (kampheng nakhon Vientiane) dan terletak di perbatasan dengan Thailand.Vientiane terletak pada 17°58' LU, 102°36' BT (17.9667, 102.6).\n","https://fhlevi13.github.io/img/ibu-kota-negara/Vientiene.jpeg"},
            {"Rangoon (Yangon)","Rangoon (Yangon) - Ibu Kota Myanmar\n" +
                    ...
                    "Naypyidaw adalah sebuah daerah terpencil di dekat kota Pyinmana. Naypyidaw yang berarti Rumah Para Raja ini berbeda dengan kota lain di Myanmar. Kota ini jauh dari kesan padat dan memiliki populasi yang lebih sedikit meskipun wilayahnya luas.","https://fhlevi13.github.io/img/ibu-kota-negara/Rangoon.jpeg"},
            {"Phnom Penh","Phnom Penh - Ibu Kota Kamboja\n" +
                    "Luas Wilayah : 758 km2 \n" +
                    "Phnom Penh (bahasa Khmer: aksara Mul PhPenh1.png; gaya biasa ភ្នំពេញ) adalah ibu kota dan kota terbesar di Kamboja. Kota ini memiliki penduduk sekitar 1 juta jiwa, sementara seluruh penduduk Kamboja adalah 11,4 juta jiwa.\n" +
                    "Terletak di tepi Sungai Mekong, Phnom Penh telah menjadi ibu kota negara sejak Kamboja dijajah Prancis. Phnom Penh telah berkembang menjadi pusat negara dan pusat industri kegiatan perekonomian, serta pusat keamanan, politik, ekonomi, warisan budaya dan pemerintahan Kamboja.\n" +
                    ...
                    "Pernah dikenal sebagai “Mutiara Asia”, dan dianggap salah satu kota peninggalan Prancis yang terindah yang pernah dibangun sebagai kota-kota-di Indochina pada tahun 1920.","https://fhlevi13.github.io/img/ibu-kota-negara/Phnom-Penh.jpeg"}
    };
